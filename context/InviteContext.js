...
export function InviteProvider({ children }) {
  ...
  const getInvites = async () => {
    try {
      const getInvites = await fetch(`${API_URL}/invite/`, {
        method: 'GET',
        headers: authHeader,
      });
  ...
  const acceptInvites = async inviteID => {
    try {
      const acceptInvites = await fetch(
        `${API_URL}/invite/accept/${inviteID}`,
        {
          method: 'PUT',
          headers: authHeader,
        }
  ...
  const rejectInvites = async inviteID => {
    try {
      const rejectInvites = await fetch(
        `${API_URL}/invite/reject/${inviteID}`,
        {
          method: 'PUT',
          headers: authHeader,
        }
  ...
  const postInvite = async userEmail => {
    try {
      ...
      const postInviteReq = await fetch(`${API_URL}/invite/create`, {
        method: 'POST',
        headers: authHeader,
  ...
  const deleteInviteSent = async inviteid => {
    ...
    try {
      const deleteInviteSent = await fetch(`${API_URL}/invite/${inviteid}`, {
        method: 'DELETE',
        headers: authHeader,
